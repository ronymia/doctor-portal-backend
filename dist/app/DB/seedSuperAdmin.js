...
const seedPermissions_1 = __importDefault(require("./seedPermissions"));
function seedSuperAdmin() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // CHECK SUPER ADMIN
        const superAdmin = yield prisma_2.prisma.user.findFirst({
            where: {
                role: user_1.ENUM_USER_ROLE.SUPER_ADMIN,
            },
        });
