...
router.post('/:id/assign-permissions', (0, auth_1.default)(user_1.ENUM_USER_ROLE.SUPER_ADMIN), user_controller_1.UserControllers.assignPermissions);
router.post('/:id/remove-permissions', (0, auth_1.default)(user_1.ENUM_USER_ROLE.SUPER_ADMIN), user_controller_1.UserControllers.removePermissions);
router.get('/:id/permissions', (0, auth_1.default)(user_1.ENUM_USER_ROLE.SUPER_ADMIN), user_controller_1.UserControllers.getUserPermissions);
