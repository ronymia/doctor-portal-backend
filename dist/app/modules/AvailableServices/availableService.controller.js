...
exports.AvailableServiceControllers = void 0;
...
const createAvailableServiceIntoDB = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const payloadData = __rest(req.body, []); //COPY
    //SEND DATA TO BUSINESS LOGIC
    const result = yield availableService_service_1.AvailableServiceServices.createAvailableServiceIntoDB(payloadData);
    //SEND RESPONSE
...
// GET BY ID  CONTROLLER FUNCTION
const getAvailableServiceById = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params; //COPY
    //SEND DATA TO BUSINESS LOGIC
    const result = yield availableService_service_1.AvailableServiceServices.getAvailableServiceByIdFromDB(id);
    //SEND RESPONSE
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const getAllAvailableServices = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    //SEND DATA TO BUSINESS LOGIC
    const result = yield availableService_service_1.AvailableServiceServices.getAllAvailableServicesFromDB(filters, paginationOptions);
    //SEND RESPONSE
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
exports.AvailableServiceControllers = {
