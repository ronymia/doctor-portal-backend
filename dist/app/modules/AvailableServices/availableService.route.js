...
availableService_controller_1.AvailableServiceControllers.createAvailableServiceIntoDB);
/***************
 * @api {post} /products
 * @apiDescription create a new product
 * @apiPermission  superAdmin , admin
 ...
 *
 *********************/
router.get('/:id', availableService_controller_1.AvailableServiceControllers.getAvailableServiceById);
/***************
 * @api {post} /products
 * @apiDescription create a new product
 * @apiPermission  superAdmin , admin
 ...
 *
 *********************/
router.get('/', availableService_controller_1.AvailableServiceControllers.getAllAvailableServices);
/***************
 * @api {post} /products
 * @apiDescription create a new product
 * @apiPermission  superAdmin , admin
