...
const createPermissionIntoDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.prisma.permission.create({
        data: payload,
    });
    return result;
});
...
const getPermissionByIdFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.prisma.permission.findUnique({
        where: { id },
    });
    return result;
});
const getAllPermissionsFromDB = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const whereCondition = andConditions.length
        ...
        : {};
    //Database
    const result = yield prisma_1.prisma.permission.findMany({
        skip,
        take: limit,
        orderBy: {
            [sortBy]: sortOrder,
    ...
    // total count
    const totalCount = yield prisma_1.prisma.permission.count();
    // return
    return {
        meta: {
            page,
...
const updatePermissionIntoDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const isExist = yield prisma_1.prisma.permission.findUnique({
        where: { id },
    });
    if (!isExist) {
        throw new AppError_1.default(http_status_1.default.NOT_FOUND, 'Permission not found');
    }
    const result = yield prisma_1.prisma.permission.update({
        where: { id },
        data: payload,
    });
    return result;
...
const deletePermissionFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.prisma.permission.delete({
        where: { id },
    });
    return result;
});
