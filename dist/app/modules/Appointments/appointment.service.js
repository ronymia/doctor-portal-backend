...
const createAppointmentIntoDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_2.prisma.appointment.create({
        data: payload,
    });
    return result;
});
...
const bookAppointmentIntoDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const patient = yield prisma_2.prisma.patient.findUnique({
        where: { id: patientId },
    });
    if (!patient) {
    ...
    const availableService = yield prisma_2.prisma.availableService.findUnique({
...
const cancelAppointment = (appointmentId) => __awaiter(void 0, void 0, void 0, function* () {
    const appointment = yield prisma_2.prisma.appointment.findUnique({
        where: {
            id: appointmentId,
        },
    });
    ...
    if (appointment.status === prisma_1.AppointmentStatus.CANCELLED) {
        throw new Error('Appointment has already been cancelled');
    }
    if (appointment.status === prisma_1.AppointmentStatus.COMPLETED) {
        throw new Error('Appointment has already been completed');
    }
    const cancelledAppointment = yield prisma_2.prisma.$transaction((transactionClient) => __awaiter(void 0, void 0, void 0, function* () {
        const appointmentToCancel = yield transactionClient.appointment.update({
            where: {
                id: appointmentId,
            },
            data: {
                status: prisma_1.AppointmentStatus.CANCELLED,
            },
        });
...
const startAppointment = (appointmentId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const startedAppointment = yield prisma_2.prisma.$transaction((transactionClient) => __awaiter(void 0, void 0, void 0, function* () {
        yield transactionClient.payment.updateMany({
            where: {
                appointmentId,
            },
        ...
        const appointmentToStart = yield transactionClient.appointment.update({
            ...
            data: {
                status: prisma_1.AppointmentStatus.PENDING_PAYMENT,
            },
        });
        if (!appointmentToStart) {
            yield transactionClient.payment.updateMany({
                ...
                data: {
                    paymentStatus: prisma_1.PaymentStatus.REFUNDED,
                },
            });
        }
...
const finishAppointment = (appointmentId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const appointmentToFinish = yield prisma_2.prisma.appointment.update({
        where: {
            id: appointmentId,
        },
        data: {
...
const getAppointmentByIdFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_2.prisma.appointment.findUnique({
        where: { id },
    });
    return result;
});
...
const getAllAppointmentsFromDB = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const whereCondition = andConditions.length
        ...
        : {};
    //Database
    const result = yield prisma_2.prisma.appointment.findMany({
        skip,
        take: limit,
        orderBy: {
            [sortBy]: sortOrder,
    ...
    // total count
    const totalCount = yield prisma_2.prisma.appointment.count();
    // return
    return {
        meta: {
            page,
...
const updateAppointmentIntoDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isExist = yield prisma_2.prisma.appointment.findUnique({
        where: { id },
    });
    if (!isExist) {
        throw new AppError_1.default(http_status_1.default.NOT_FOUND, 'Appointment not found');
    }
    const result = yield prisma_2.prisma.appointment.update({
        where: { id },
        data: payload,
    });
    return result;
...
const deleteAppointmentFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // DELETE FROM DATABASE
    const result = yield prisma_2.prisma.appointment.delete({
        where: { id },
    });
    return result;
});
