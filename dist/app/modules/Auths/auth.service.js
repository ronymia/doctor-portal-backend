...
const loginUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if ((user === null || user === void 0 ? void 0 : user.status) === client_1.UserAccountStatus.BLOCKED) {
    ...
    // CREATE access_token
    const accessToken = jwtHelpers_1.JwtHelpers.createToken({ user_id, role }, config_1.default.jwt.secret, config_1.default.jwt.expires_in);
    // CREATE refresh_token
    const refreshToken = jwtHelpers_1.JwtHelpers.createToken({ user_id, role }, config_1.default.jwt.refresh_secret, config_1.default.jwt.refresh_expires_in);
    // DELETE PASSWORD
    if ('password' in user) {
